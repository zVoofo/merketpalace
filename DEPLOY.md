...
**Ограничение:** загруженные фото без облачного хранилища могут пропадать после «сна» сервера.  
**Для РФ:** настройте **Яндекс Object Storage** — см. [STORAGE.md](STORAGE.md) (Cloudinary в России недоступен).
